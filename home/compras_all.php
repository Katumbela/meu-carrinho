...
<head>
    ...
    <title>Suas Compras | Meu Carrinho</title>
...
<body>
    ...
    <div class="container">
        ...
        <center style="margin-top: -3rem;">
            <img src="../img/del.jpg" height="90em" alt="">
            <h1 class="text-danger">Compras a caminho</h1>
        </center>
        <br>
        <div class="row">
        ...
        <?php
            ...
            $get_p = $conexao->query("SELECT * FROM carrinho WHERE en_ip = '$codigo' AND given = 'no' AND placed='yes'");
        ...
        ?>
            ...
            <div class="col-12 my-2 col-md-6 col-lg-4">
                <div class="item_ shadow gap-0 rounded-pill d-flex" style="background: #ff808062!important">
                    <img src="../partner/produtos_lojas/<?=$prods['foto_prod']?>" height="100em" alt="">
                    <div>
                        <h4><?=$prods['produto']?></h4>
                        <div style="display: flex; flex-direction: column; gap: 0">
                        <span style="font-size: 10px">Comprou em: <b>Loja 1</b></span>
                        <span style="font-size: 10px">Data: <b><?=$pro['quando']?></b> &middot; Agente <b class="text-success">Unknown</b></span>
                        <button onclick="delivered('<?=$ref_p?>','<?=$id_p?>')" class="btn w-75 d-flex justify-content-between btn-success rounded-pill mt-1" style="height: 1.3rem; line-height: .4rem"> 
                            <!-- Generated by IcoMoon.io -->
                            <svg fill="currentColor" style="margin-top: -.25rem!important" class="rounded-circle text-success bg-white my-auto" version="1.1" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24">
                            <title>check</title>
        ...
        <?php
            ...
            if ($lin_p <= 0) {
                ...
                <div class="col-12 col-md-12">
                    <center><span class="text-secondary">Não efectuou ainda nenhuma compra <b>#BOSS <span class="text-danger"><?=$nome?></span></b> ou A suas compras já foram entregues</span></center>
                </div>
...
function delivered(typeProd,typeID) {
    ...
    var form_data = {
     ...
     $.post('./func_f/set_status_buy.php', form_data, function(resp) {
                
                Swal.fire(
                    'Alterado',
                    "Marcado como "+ resp +", recarregue a página",
                    'success'
